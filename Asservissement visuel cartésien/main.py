...
class Fenetre(QMainWindow):
    ...
    def visual_servoing(self):
        ...
        if self.count == max_count - 1:
            ...
            # erreur_image = ...
            erreur_image = pos_image_desiree - pos_image_courante
            ...
            # A1 = ...
            A1 = np.array([[f_e / dim_x_e, 0.0], [0.0, f_e / dim_y_e]])
            ...
            # J_im = ...
            #jacobienne image est un tableau 2D qui lie la vitesse des pixels dans l'image à la vitesse de l'organe terminal
            J_im = np.array([[-1.0 / d_e, 0.0], [0.0, -1.0 / d_e]])
